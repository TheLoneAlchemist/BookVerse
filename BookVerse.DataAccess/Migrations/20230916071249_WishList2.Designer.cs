...
namespace BookVerse.DataAccess.Migrations
{
    ...
    [Migration("20230916071249_WishList2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookVerse.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookVerse.Models.Checkout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookVerse.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookVerse.Models.OrderedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookVerse.Models.WishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookVerse.Models.BasketItem", b =>
                {
                    b.HasOne("BookVerse.Models.Cart", "Cart")
            ...
            modelBuilder.Entity("BookVerse.Models.Checkout", b =>
                {
                    b.HasOne("BookVerse.Models.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("BookVerse.Models.Order", b =>
                {
                    b.HasOne("BookVerse.Models.Checkout", "Checkout")
                        .WithMany()
            ...
            modelBuilder.Entity("BookVerse.Models.OrderedItem", b =>
                {
                    b.HasOne("BookVerse.Models.Order", "Order")
